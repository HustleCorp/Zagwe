...
export const useFirestore = (container: Container) => {
  container
    ...
    .to(AuthorizeService);
  container
    .bind<ICircleService>(SocialProviderTypes.CircleService)
    .to(CircleService);
  container
    .bind<ICommentService>(SocialProviderTypes.CommentService)
    .to(CommentService);
  container
    .bind<ICommonService>(SocialProviderTypes.CommonService)
    .to(CommonService);
  container
    .bind<IStorageService>(SocialProviderTypes.StorageService)
    .to(StorageService);
  container
    .bind<IImageGalleryService>(SocialProviderTypes.ImageGalleryService)
    .to(ImageGalleryService);
  container
  ...
  container
    .bind<IGraphService>(FirestoreClientTypes.GraphService)
    .to(GraphService);
  container
    .bind<IUserTieService>(SocialProviderTypes.UserTieService)
    .to(UserTieService);
};
