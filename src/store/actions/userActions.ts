 ...
 */
const userService: IUserService = provider.get<IUserService>(
...
export const dbGetUserOther = () => {
  return (dispatch: any, getState: Function) => {
    ...
    if (uid) {
      return userService
        .getUserOther(uid)
        .then((otherUserProfile: OtherProfile) => {
          dispatch(
            addUserOther(uid, {
...
export const dbUpdateUserOther = (newOther: OtherProfile) => {
  return (dispatch: any, getState: Function) => {
    ...
    return userService
      .updateUserOtherProfile(uid, updatedProfile)
      .then(() => {
...
export const dbGetPeopleInfo = (page: number, limit: number) => {
  return (dispatch: any, getState: Function) => {
    ...
    if (uid && lastPageRequest !== page) {
      return userService
        .getUsersProfile(uid, lastUserId, page, limit)
        .then(result => {
