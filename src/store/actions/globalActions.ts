 ...
 */
const commonService: ICommonService = provider.get<ICommonService>(
  SocialProviderTypes.CommonService,
);
...
export const showNotificationRequest = () => {
  return (dispatch: Function, getState: Function) => {
    ...
    return dispatch(
      showMessage(String(translate('common.sentRequestMessage'))),
    );
  };
};
...
export const showNotificationSuccess = () => {
  return (dispatch: Function, getState: Function) => {
    ...
    return dispatch(
      showMessage(
        String(translate('common.successfulRequestMessage')),
        'success',
      ),
    );
  };
