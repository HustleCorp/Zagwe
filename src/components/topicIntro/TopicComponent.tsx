 ...
 */
export class TopicIntro extends Component<
  ItopicIntroComponentProps,
  ItopicIntroComponentState
> {
  static propTypes = {
    /**
    ...
    return (
      <div className={classes.topicIntro}>
        <div className={classes.pnotr}>
          <div>
            <h1 className={classes.body}>{title}</h1>
            <div className={classes.bio}>
              <div>
                <h2 className={classes.text}>{bio}</h2>
              </div>
            </div>
          </div>
...
const mapDispatchToProps = (
  dispatch: Function,
  ownProps: ItopicIntroComponentProps,
) => {
  return {};
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withStyles(topicStyle as any)(TopicIntro as any) as any);
