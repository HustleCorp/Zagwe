 ...
 */
const mapDispatchToProps = (dispatch: Function, ownProps: IfeaturedBoxComponentProps) => {
  return {
 ...
 * @return {object}          props of component
 */
const mapStateToProps = (state: any, ownProps: IfeaturedBoxComponentProps) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles as any)(FeaturedBoxComponent as any))
