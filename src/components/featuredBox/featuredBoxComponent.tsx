 ...
 */
export class FeaturedBoxComponent extends Component<
  IfeaturedBoxComponentProps,
  IfeaturedBoxComponentState
> {
  /**
    ...
    return (
      <div style={{paddingBottom: '2px'}}>
        <Card
          ...
          style={{width: '20rem', marginLeft: '0px', marginRight: '15px'}}
        >
            ...
            <div style={{display: 'flex', marginLeft: '-12px'}}>
              ...
              <div style={{display: 'grid', paddingLeft: '10px'}}>
                <div style={{display: 'flex'}}>
                  ...
                  {isAdmin === true ? (
                    <span style={{marginTop: '-22px'}}>{rightIconMenu}</span>
                  ) : (
                    ''
                  )}
                </div>
                ...
                <div
                  className={loaded ? 'featured-info' : 'animated-info'}
                  style={{color: '#8b9898'}}
                >
                  <span>
