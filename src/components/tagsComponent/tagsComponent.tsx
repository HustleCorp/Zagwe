  ...
  _addTags(tags: any) {
    ...
    if (onlyUnique) {
      ...
      tags = tags.filter((tag: any) =>
        value.every(
          currentTag =>
            this._getTagDisplayValue(currentTag) !==
            this._getTagDisplayValue(tag),
        ),
      );
    }

    const rejectedTags = tags.filter(
      (tag: any) => !validationRegex.test(this._getTagDisplayValue(tag)),
    );
    tags = tags.filter((tag: any) =>
      validationRegex.test(this._getTagDisplayValue(tag)),
    );
    tags = tags.filter((tag: any) => {
