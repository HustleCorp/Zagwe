...
export class FeaturedComponent extends Component<
  IfeaturedComponentProps,
  IfeaturedComponentState
> {
  /**
      ...
      <div id="topContainer">
        <div style={{display: 'flex'}}>
          ...
          <div
            key={'featuredGrid'}
            id="featuredList"
            className="grid_overflow grid__1of4 grid__space-between custom-scroll 
                "
          >
            {postList}
          </div>
          <div className={classes.scrollContainer}>
            <div
              style={{display: overflow ? 'inline-block' : 'none'}}
...
const mapDispatchToProps = (
  dispatch: Function,
  ownProps: IfeaturedComponentProps,
) => {
  return {
...
const mapStateToProps = (state: any, ownProps: IfeaturedComponentProps) => {
  ...
  const featuredPosts: Map<string, any> = state.getIn(
    ['post', 'featuredPosts'],
    {},
  );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withStyles(styles as any)(FeaturedComponent as any));
