...
const searchClient = algoliasearch(
  'GDLJD9WT4N',
  '1a976afc8891eef33f27a09de414146c',
);
    ...
    return (
      <div onClick={this.handleClose}>
        <NavLink to={`/posts/${props.hit.ownerUserId}/${props.hit.objectID}`}>
          <img
            style={{width: 'auto'}}
            src={props.hit.thumbImage}
            alt={props.hit.thumbImage}
          />
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar className={classes.Toolbar}>
                ...
                <div className={classes.homeRight}>
                  {this.props.notifyCount! > 0 ? (
                    <IconButton arial-label="Notification">
                      <Badge
                        badgeContent={this.props.notifyCount}
                        color="primary"
                      >
                        <NotificationsIcon
                          onClick={this.handleNotifyTouchTap}
                          color="secondary"
                        />
                      </Badge>
                    </IconButton>
          ...
          >
            ...
            <MenuItem style={{fontSize: '14px'}} onClick={this.handleLogout}>
              {' '}
        ...
        >
          <InstantSearch
            indexName={this.state.tabIndex === 0 ? 'posts' : 'users'}
          ...
          >
            ...
            <div className={classes.spaceSearch}></div>
            <Tabs
            ...
            <Hits
              hitComponent={
                this.state.tabIndex === 0 ? this.HitPost : this.HitUser
              }
            />
            <Pagination />
          </InstantSearch>
...
const mapStateToProps = (
  ...
  const userNotifies: Map<string, any> = state.getIn([
    'notify',
    'userNotifies',
  ]);
