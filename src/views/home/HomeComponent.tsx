...
> {
  ...
  render() {
    ...
    const displayTop = url
      ? url.match('/t/') !== null || url === '/' || url.match('/posts/')
      : false;
      ...
      <div className={classes.root}>
        <div className={classes.appFrame}>
          ...
          <div
            ...
            style={{display: displayTop ? 'inline-block' : 'none'}}
          >
            <Tabs
            ...
            >
              ...
              <Tab
                style={{display: isGuest ? 'none' : ''}}
                label={`${TagLabel.topic2}`}
              />{' '}
              : ''}
...
const mapStateToProps = (
  ...
  const hasMorePosts = state.getIn(
    ['post', 'stream', 'userPosts', 'hasMoreData'],
    true,
  );
...
export default withRouter<any>(
  connect(
    mapStateToProps,
    mapDispatchToProps,
  )(withStyles(styles as any, {withTheme: true})(HomeComponent as any) as any),
