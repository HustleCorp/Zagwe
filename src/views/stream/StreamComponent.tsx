...
> {
  ...
  postLoad = () => {
    ...
    if (posts === undefined || !(posts.keySeq().count() > 0)) {
      ...
      let postBack: {
        ...
        oddPostList: Post[];
        evenPostList: Post[];
      } = {divided: false, oddPostList: [], evenPostList: []};
  ...
  render() {
    ...
    return (
      ...
      >
        <div
          className={`grid grid__gutters grid__1of2 ${
            tag ? 'grid__left' : 'grid__center'
          } animate-top`}
        >
          <div
            className="grid-cell animate-top"
            style={{maxWidth: '700px', minWidth: '400px', paddingLeft: '0px'}}
          >
          ...
          {postList.divided ? (
            <div
              className="grid-cell animate-top"
              style={{maxWidth: '530px', minWidth: '530px'}}
            >
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(StreamComponent as any) as any,
) as typeof StreamComponent;
