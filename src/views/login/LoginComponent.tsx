    ...
    const OAuthLogin = (
      <div style={this.styles.singinOptions as any}>
        ...
        >
          ...
          <div className={classes.textSocial}>Login With Facebook</div>
        </Button>
        <Button
          variant="outlined"
          size="small"
        ...
        >
          ...
          <div className={classes.textGoogle}>Login With Google</div>
        </Button>
      </div>
    );
...
export default withRouter<any>(
  connect(
    ...
    withStyles(styles as any)(
      localize(LoginComponent as any, 'locale', CommonAPI.getStateSlice) as any,
    ) as any,
  ),
