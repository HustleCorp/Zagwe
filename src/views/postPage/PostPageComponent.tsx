      ...
      <div className={classes.container}>
        <div className={classes.postContent}>
          ...
          <div className={classes.ownerDisplayName}>
            {`Written by ${
              post.get('ownerDisplayName') ? post.get('ownerDisplayName') : ''
            }`}
          </div>
        ...
        <div style={{display: 'flex', flexWrap: 'wrap'}}>{tagCrumbs}</div>
        <div className={classes.social}>
          <div className={classes.socialInside}>
            ...
            <div className={classes.socialRight}>
              ...
              <div>
                <FacebookShareButton
                  url={`${location.origin}/posts/${post.get(
                    'ownerUserId',
                  )}/${post.get('id')}`}
                  quote={post.get('body')}
        ...
        <AsyncComment
          ...
          ownerPostUserId={post.get('ownerUserId')}
...
const mapDispatchToProps = (
  ...
  return {
    ...
    getPostComments: () =>
      dispatch(commentActions.dbFetchComments(userId, postId)),
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withStyles(postPage as any)(PostPageComponent as any) as any);
