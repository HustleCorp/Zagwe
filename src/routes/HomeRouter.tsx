  ...
  render() {
    ...
    return enabled ? (
      <Switch>
        ...
        />
        <PrivateRoute
          path="/submit/:userId?/:postId?"
          component={<Sub edit={false} />}
        />
        ...
        <Route
          path="/postseo/:userId/:postId/:tag?"
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(HomeRouter as any) as any,
) as typeof HomeRouter;
